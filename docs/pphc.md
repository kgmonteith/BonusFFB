...
- **<span id="brake-axis-scaling">Brake axis scaling:</span>** Controls the scaling of the output brake axis value. Lower values means more stick deflection is needed for full braking force, higher values means less deflection is needed. It's recommended to tweak this value such that maximum brake force occurs before the joystick pushes back with its maximum force.

### Throttle settings

- **<span id="throttle-spring-strength">Throttle spring strength:</span>** Sets the strength of the throttle spring. Higher values means a stronger spring.
